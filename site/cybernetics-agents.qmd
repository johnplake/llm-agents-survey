...
**Research, Design, and Conversation as One Circular Activity.** In ["Researching Design and Designing Research"](https://www.ida.liu.se/~steho87/desres/glanville.pdf) (*Design Issues*, 15(2), 80–91, 1999), Glanville argued that research and design are structurally identical circular activities — both involve making distinctions, exploring a space of possibilities, and constructing an answer that was not given in advance. He further argued that conversation is the underlying form of both: design is a circular, conversational process between the designer-who-draws and the designer-who-observes the drawing. His canonical formulation: "cybernetics is the theory of design and design is the action of cybernetics."

**Practicing Cybernetics Cybernetically.** Glanville's most distinctive contribution was insisting that if cybernetics is the science of circular processes and self-reference, it should itself be practiced as such. As ASC president, he addressed [Margaret Mead's 1967 challenge](https://en.wikipedia.org/wiki/American_Society_for_Cybernetics) to apply cybernetic principles to the organization of the society itself. He implemented genuinely conversational conference formats — no parallel sessions, everyone in one room, attention to the conditions of the conversation itself — as described in ["A conference doing the cybernetics of cybernetics"](https://doi.org/10.1108/03684921111160197) (*Kybernetes*, 40(7/8), 952–963, 2011). His canonical encyclopedia treatment is ["Second Order Cybernetics"](https://www.pangaro.com/glanville/Glanville-SECOND_ORDER_CYBERNETICS.pdf) in the *Encyclopaedia of Life Support Systems* (EoLSS, 2002).
...
*P-individuals and instance agents.* Pask's distinction between P-individuals (abstract cognitive entities constituted by conversational commitments) and M-individuals (their physical instantiations) maps directly onto the *instance agent* framing discussed on the [philosophy page](philosophy.qmd): the relevant unit of cognitive agency is the individual LLM run — the conversation in progress — not the weight tensor at rest. The conversation itself is the agent.
...
Where Shannon treated information as substrate-independent — a measure of uncertainty separable from any particular physical medium — N. Katherine Hayles argues that this move was a conceptual error with far-reaching consequences. In *[How We Became Posthuman: Virtual Bodies in Cybernetics, Literature, and Informatics](https://press.uchicago.edu/ucp/books/book/chicago/H/bo3769963.html)* (University of Chicago Press, 1999), Hayles traces how the postwar cybernetic tradition, beginning with the Macy Conferences, came to treat information as disembodied — able to "travel" from one physical substrate to another while remaining invariant. Her argument: this disembodiment was not a discovery but a *construction*, achieved by abstracting away precisely the material features that make information meaningful.
...
- Glanville, R. (1982). Inside every white box there are two black boxes trying to get out. *Behavioral Science*, 27(1), 1–11. [DOI:10.1002/bs.3830270102](https://doi.org/10.1002/bs.3830270102)
- Glanville, R. (1999). Researching design and designing research. *Design Issues*, 15(2), 80–91. [PDF](https://www.ida.liu.se/~steho87/desres/glanville.pdf)
- Glanville, R. (2002). Second order cybernetics. In F. Parra-Luna (Ed.), *Systems science and cybernetics* (Encyclopaedia of Life Support Systems). EoLSS. [PDF via pangaro.com](https://www.pangaro.com/glanville/Glanville-SECOND_ORDER_CYBERNETICS.pdf)
- Glanville, R. (2011). Introduction: A conference doing the cybernetics of cybernetics. *Kybernetes*, 40(7/8), 952–963. [DOI:10.1108/03684921111160197](https://doi.org/10.1108/03684921111160197)
- Leonard, A. (2000). The viable system model and knowledge management. *Kybernetes*, 29(5/6), 710–715. [DOI:10.1108/03684920010333143](https://doi.org/10.1108/03684920010333143)
- Beer, S. (1994). *Beyond Dispute: The Invention of Team Syntegrity*. John Wiley & Sons.
- Pask, G. (1975). *Conversation, Cognition and Learning: A Cybernetic Theory and Methodology*. Elsevier. ISBN 0-444-41193-3. [Amazon](https://www.amazon.com/Conversation-cognition-learning-cybernetic-methodology/dp/0444411933)
- Pask, G. (1976). *Conversation Theory: Applications in Education and Epistemology*. Elsevier. ISBN 0-444-41424-X. [archive.org](https://archive.org/details/conversationtheo0000pask)
...
- Luhmann, N. (1984/1995). *Social Systems*. Stanford University Press. Trans. John Bednarz, Jr. with Dirk Baecker. [Stanford UP](https://www.sup.org/books/sociology/social-systems)
...
- Hayles, N.K. (1999). *How We Became Posthuman: Virtual Bodies in Cybernetics, Literature, and Informatics*. University of Chicago Press. [UChicago Press](https://press.uchicago.edu/ucp/books/book/chicago/H/bo3769963.html)
- Hayles, N.K. (2002). *Writing Machines*. MIT Press. [MIT Press](https://direct.mit.edu/books/book/2567/Writing-Machines)
- Hayles, N.K. (2017). *Unthought: The Power of the Cognitive Nonconscious*. University of Chicago Press. [UChicago Press](https://press.uchicago.edu/ucp/books/book/chicago/U/bo25861765.html)
- Simondon, G. (1958/2017). *On the Mode of Existence of Technical Objects*. Trans. Cecile Malaspina & John Rogove. Univocal Publishing. ISBN 9781517904876. [UMN Press](https://www.upress.umn.edu/9781517904876/on-the-mode-of-existence-of-technical-objects/)
- Simondon, G. (1958/2020). *Individuation in Light of Notions of Form and Information*. Trans. Taylor Adkins. University of Minnesota Press. [UMN Press](https://www.upress.umn.edu/9780816680023/individuation-in-light-of-notions-of-form-and-information/)
- Peters, B. (2016). *How Not to Network a Nation: The Uneasy History of the Soviet Internet*. MIT Press. [MIT Press](https://mitpress.mit.edu/9780262534666/how-not-to-network-a-nation/)
...
- De Zeeuw, G. (2001). Interaction of actors theory. *Kybernetes*, 30(7–8), 971–983. [DOI:10.1108/03684920110396864](https://doi.org/10.1108/03684920110396864)
- Tilak, S., Manning, T., Glassman, M., Pangaro, P. & Scott, B. (2024). Gordon Pask's Conversation Theory and Interaction of Actors Theory: Research to Practice. *Enacting Cybernetics*. [DOI:10.58695/ec.11](https://doi.org/10.58695/ec.11)
- Manning, T. (2025). A Concept Must Be Some Kind of Process. *Enacting Cybernetics*, 3(1):3. [DOI:10.58695/ec.19](https://doi.org/10.58695/ec.19)
- Battle, S. (2025). [Conversation Theory for Design Agents](https://rsdsymposium.org/conversation-theory/). *Relating Systems Thinking and Design (RSD) Symposium*. *(Applies Pask's CT explicitly to LLM agent design; shows that entangled conversations between an LLM and a critic produce more stable, performant systems than either alone.)*
- Dubberly, H., & Pangaro, P. (2009). [What is conversation? How do we design for effective conversation?](https://www.dubberly.com/wp-content/uploads/2009/05/ddo_article_whatisconversation.pdf) *ACM Interactions*, July/August 2009.
...
- Wu, J. et al. (2025). [Towards Open Complex Human-AI Agents Collaboration Systems for Problem Solving and Knowledge Management](https://arxiv.org/abs/2505.00018). arXiv:2505.00018. *(Grounds a new AI agent architecture in Conversation Theory, cybernetics, and autopoiesis.)*
- Glassman, M., Manning, T., & Tilak, S. (2024). [A Cybernetic Perspective on Generative AI in Education: From Transmission to Coordination](https://www.ijimai.org/index.php/ijimai/article/view/329). *International Journal of Interactive Multimedia and Artificial Intelligence*. *(Applies Bateson and cybernetic frameworks to generative AI in education.)*
...
- [Gordon Pask — Wikipedia](https://en.wikipedia.org/wiki/Gordon_Pask)
- [Conversation Theory — Wikipedia](https://en.wikipedia.org/wiki/Conversation_theory)
- [Gordon Pask PDFs & Resources — Paul Pangaro](https://pangaro.com/pask-pdfs.html)
- [Second-Order Cybernetics — Wikipedia](https://en.wikipedia.org/wiki/Second-order_cybernetics)
- [Ranulph Glanville — Wikipedia](https://en.wikipedia.org/wiki/Ranulph_Glanville)
- [Ranulph Glanville Article Repository](https://ranulphglanville.org.za/)
- [Allenna Leonard — Wikipedia](https://en.wikipedia.org/wiki/Allenna_Leonard)
...
- [N. Katherine Hayles — Wikipedia](https://en.wikipedia.org/wiki/N._Katherine_Hayles)
- [Gilbert Simondon — Wikipedia](https://en.wikipedia.org/wiki/Gilbert_Simondon)
- [Victor Glushkov — Wikipedia](https://en.wikipedia.org/wiki/Victor_Glushkov)
- [OGAS — Wikipedia](https://en.wikipedia.org/wiki/OGAS)
- [Cybernetics in the Soviet Union — Wikipedia](https://en.wikipedia.org/wiki/Cybernetics_in_the_Soviet_Union)
- [How the Soviets invented the internet and why it didn't work — Aeon](https://aeon.co/essays/how-the-soviets-invented-the-internet-and-why-it-didnt-work)
