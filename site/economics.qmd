...
- **Multi-step amplification** — a 10-step ReAct agent doesn't cost 10× a single LLM call: it costs 10 full-context LLM calls, each including the accumulated history of all prior steps. Cost scales quadratically with context length in token-priced APIs.
...
Separately, **"Increasing the Thinking Budget is Not All You Need"** ([arXiv:2512.19585](https://arxiv.org/abs/2512.19585), 2025) shows empirically that simply allocating more thinking budget doesn't reliably improve performance — and that most tasks achieve optimal results at 256–512 thinking tokens, with smaller models benefiting more from extended thinking than larger ones. This reframes the thinking budget as an allocation problem, not just an upper bound.
...
**HBPO** ([arXiv:2507.15844](https://arxiv.org/abs/2507.15844), 2025) assigns reasoning budgets hierarchically based on problem difficulty. Applied to DeepSeek-R1-Distill-Qwen-1.5B, it improves average accuracy from 56.3% to 59.4% while **reducing token usage by 60.6%** (from 7,921 to 3,120 tokens on average).
...
**Caching strategies.** Beyond prompt caching for static prefixes, result caching — storing the output of expensive tool calls or LLM calls so they needn't be repeated for identical inputs — can dramatically reduce costs in agents that repeatedly query the same external APIs or documents.
...
**Plan-and-Act** ([arXiv:2503.09572](https://arxiv.org/abs/2503.09572), Lee et al., ICML 2025) separates high-level planning from low-level execution into distinct Planner and Executor models, recognizing that different agent roles benefit from different specialized training. It achieves 57.58% success on WebArena-Lite and 81.36% on WebVoyager (text-only SOTA), validating the expensive-planner/cheap-executor architecture pattern.
...
**Anthropic's "Measuring AI Agent Autonomy in Practice"** (2026) analyzed millions of real human-agent interactions across Claude Code and Anthropic's public API, finding that the "set it and forget it" vision of autonomous agents is still rare in practice:
...
- Among longest-running sessions, agent-initiated stops for clarification occur more than twice as often as human interruptions — agents are self-limiting more than users think
...
Operational costs dominate enterprise AI agent TCO: empirical data from 60+ real implementations shows operational costs represent **65–75% of total 3-year spending**, vastly exceeding initial build costs.
...
- **Towards Efficient Multi-LLM Inference: Routing and Hierarchical Techniques** (Behera et al., 2025) — [arXiv:2506.06579](https://arxiv.org/abs/2506.06579) *(survey of routing vs. cascading as complementary strategies)*
...
- **Plan-and-Act: Improving Planning of Agents for Long-Horizon Tasks** (Lee et al., ICML 2025) — [arXiv:2503.09572](https://arxiv.org/abs/2503.09572) *(separate Planner and Executor models; 57.58% WebArena-Lite, 81.36% WebVoyager)*
...
- **INTENT: Intention-Based Planning for Costly Tool Use** (2026) — [arXiv:2602.11541](https://arxiv.org/abs/2602.11541) *(intention-aware hierarchical world model for monetary tool budget enforcement)*
...
- **L1: Controlling Reasoning Length with Reinforcement Learning / LCPO** (CMU, 2025) — [arXiv:2503.04697](https://arxiv.org/abs/2503.04697) *(RL-trained length control; uncovers Short Reasoning Models)*
...
- **BudgetThinker: Budget-aware LLM Reasoning with Control Tokens** (2025) — [arXiv:2508.17196](https://arxiv.org/abs/2508.17196) *(control tokens for budget awareness; curriculum-based RL training)*
...
- **Increasing the Thinking Budget is Not All You Need** (2025) — [arXiv:2512.19585](https://arxiv.org/abs/2512.19585) *(most tasks optimal at 256–512 thinking tokens; smaller models benefit more)*
...
- **Beyond Accuracy: The CLEAR Framework for Enterprise Agentic AI** (2025) — [arXiv:2511.14136](https://arxiv.org/abs/2511.14136) *(50× cost variation at same accuracy; 4.4–10.8× savings from cost-aware design)*
...
- **The Emerging Market for Intelligence: Pricing, Supply, and Demand for LLMs** (Demirer, Fradkin, Tadelis, Peng, 2025) — [NBER WP 34608](https://www.nber.org/papers/w34608) *(600+ models by late 2025; LLM market shifts to intense price competition)*
...
- **Measuring AI Agent Autonomy in Practice** (Anthropic, 2026) — [anthropic.com/research/measuring-agent-autonomy](https://www.anthropic.com/research/measuring-agent-autonomy) *(73% of tool calls have human oversight; 0.8% irreversible; empirical autonomy data)*
- **McKinsey State of AI 2025** — [mckinsey.com](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-ai) *(88% of organizations use AI; ~6% capture meaningful value)*
