...
**AgentHarm** (2025) · [arXiv:2410.09024](https://arxiv.org/abs/2410.09024)  
...
**[aiagentindex.mit.edu](https://aiagentindex.mit.edu)** · [arXiv:2602.17753](https://arxiv.org/abs/2602.17753)
...
| **ST-WebAgentBench** · [arXiv:2410.06703](https://arxiv.org/abs/2410.06703) | Safety instruction following in web tasks (222 tasks, CuP metric) | Average CuP < 2/3 of nominal completion rate; critical safety gaps exposed |
...
- **InjecAgent: Benchmarking Indirect Prompt Injections in Tool-Integrated Large Language Model Agents** (Zhan et al., 2024) — [arXiv:2403.02691](https://arxiv.org/abs/2403.02691)
- **AgentDojo: A Dynamic Environment to Evaluate Prompt Injection Attacks and Defenses for LLM Agents** (Debenedetti et al., 2024) — [arXiv:2406.13352](https://arxiv.org/abs/2406.13352)
- **AgentHarm: A Benchmark for Measuring Harmfulness of LLM Agents** (Andriushchenko et al., 2025) — [arXiv:2410.09024](https://arxiv.org/abs/2410.09024)
- **Constitutional AI: Harmlessness from AI Feedback** (Bai et al., Anthropic, 2022) — [arXiv:2212.08073](https://arxiv.org/abs/2212.08073)
- **The 2025 AI Agent Index: Documenting Technical and Safety Features of Deployed Agentic AI Systems** (Staufer et al., 2025) — [arXiv:2602.17753](https://arxiv.org/abs/2602.17753)
