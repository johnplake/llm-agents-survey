...
A separate harder benchmark, **SWE-bench Pro** (Scale Labs), tests generalization on never-before-seen private codebases. GPT-5 and Claude Opus 4.1 both score only ~23% there *(approximate; source needed)* vs. 70%+ on Verified, revealing substantial overfitting to public repos.
...
**Butterfly Effect / Monica.im (China)** · [manus.im](https://manus.im) · [arXiv:2505.02024](https://arxiv.org/html/2505.02024v1)
...
- **Manus AI: Autonomous AI Agent Framework** (Butterfly Effect / Monica.im, 2025) — [arXiv:2505.02024](https://arxiv.org/abs/2505.02024)
...
- **MIT AI Agent Index** (2025) — [aiagentindex.mit.edu](https://aiagentindex.mit.edu)
  - Companion paper: [arXiv:2602.17753](https://arxiv.org/abs/2602.17753)
