...
A separate harder benchmark, **SWE-bench Pro** (Scale Labs), tests generalization on never-before-seen private codebases. GPT-5 and Claude Opus 4.1 both score only ~23% there vs. 70%+ on Verified, revealing substantial overfitting to public repos.
