...
LLM agents are being applied to the complex, multi-step workflow of clinical trial management. [**AutoCT**](https://arxiv.org/abs/2506.04293) (Liu et al., 2025) automates interpretable clinical trial outcome prediction by combining LLM reasoning with classical machine learning, addressing the interpretability requirements that clinical trial decision-making demands. [**ClinicalReTrial**](https://arxiv.org/pdf/2601.00290) (2025) explores self-evolving agents for clinical trial protocol design.

Drug discovery is among the richest application areas for agentic AI. A [comprehensive survey of AI agents in drug discovery](https://arxiv.org/abs/2510.27130) (2025) shows how agents autonomously reason through complicated multi-step research workflows spanning target identification, lead optimization, and toxicity prediction — tasks that require integrating diverse data types and computational tools. A [modular LLM agent framework for drug discovery](https://arxiv.org/abs/2507.02925) (2025) automates key tasks across the early-stage computational pipeline, combining LLM reasoning with tools including AlphaFold wrappers for structure prediction and structural databases.
...
LLM agents are also being applied to **contract analysis and M&A due diligence**. [Research on legal NLP for due diligence](https://arxiv.org/abs/2505.21281) (2025) reviews how multi-agent and single-agent LLMs are being applied to contract review tasks. [**ContractEval**](https://arxiv.org/abs/2508.03080) (2025) introduces a benchmark for clause-level legal risk identification in commercial contracts, finding that larger model size does not always guarantee better performance and that fine-tuning on domain-specific contract data remains important.

### Challenges Specific to Legal Agents

**Hallucinated citations** are the defining failure mode of legal LLMs. Several high-profile incidents involving attorneys submitting AI-generated briefs with fabricated case citations — including the widely reported *Mata v. Avianca* case in 2023 — have driven courts to require disclosure of AI use. As of May 2024, more than 25 federal judges had issued standing orders instructing attorneys to disclose or monitor AI use in their courtrooms.
...
[**FinanceBench**](https://arxiv.org/abs/2311.11944) (Islam et al., 2023) is a benchmark comprising **10,231 questions** about publicly traded companies, derived from SEC filings, with corresponding answers and evidence strings. Questions require numerical reasoning over financial statements such as income statements, balance sheets, and cash flow reports. FinanceBench revealed that even state-of-the-art LLMs frequently make arithmetic errors or hallucinate financial figures — a serious concern in advisory contexts. Retrieval-augmented systems substantially outperform pure generation on this benchmark, reinforcing the importance of grounding.

[**FinanceQA**](https://arxiv.org/abs/2501.18062) (2025) extends the financial QA landscape with a focus on evaluating LLMs' financial analysis reasoning capabilities, including multi-hop reasoning over multiple financial documents — a requirement for realistic analyst tasks.
...
[**ChemCrow**](https://arxiv.org/abs/2304.05376) (Bran et al., 2023; published in *Nature Machine Intelligence*, 2024) is the landmark demonstration of chemistry-specialized agents. By equipping GPT-4 with **18 expert-designed tools** — including RDKit for cheminformatics, web and literature search, reaction planning software, and safety checkers — ChemCrow successfully handled tasks across organic synthesis, drug discovery, and materials design that LLMs alone could not perform reliably. The agent autonomously planned and executed the syntheses of an insect repellent and three organocatalysts, demonstrating end-to-end agentic capability in a real scientific domain. ChemCrow is open-source and available on [GitHub](https://github.com/ur-whitelab/chemcrow-public).

### Mathematics

[**MathAgent**](https://arxiv.org/abs/2312.08926) (Hu et al., 2023) explored LLM-based agents for complex mathematical reasoning by defining pools of actions that decompose proofs and calculations into logical subproblems. Experiments on the miniF2F and MATH benchmarks showed improvements over GPT-4 baselines, demonstrating that structuring LLM reasoning as agent actions yields gains on hard mathematical problems. More recently, [**AgentMath**](https://arxiv.org/abs/2512.20745) (2024) integrates LLM reasoning with code execution for precise symbolic computation and arithmetic, delegating calculation to a Python interpreter rather than relying on the LLM's notoriously unreliable arithmetic.
...
- [AI Agents in Drug Discovery](https://arxiv.org/abs/2510.27130) (2025). arXiv:2510.27130.
- [Large Language Model Agent for Modular Task Execution in Drug Discovery](https://arxiv.org/abs/2507.02925) (2025). arXiv:2507.02925.
...
- [ContractEval: Benchmarking LLMs for Clause-Level Legal Risk Identification](https://arxiv.org/abs/2508.03080) (2025). arXiv:2508.03080.
...
- Hu, S. et al. (2023). [Modeling Complex Mathematical Reasoning via Large Language Model based MathAgent](https://arxiv.org/abs/2312.08926). arXiv:2312.08926.
- [AgentMath: Empowering Mathematical Reasoning via Tool-Augmented Agent](https://arxiv.org/abs/2512.20745) (2024). arXiv:2512.20745.
