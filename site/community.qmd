...
### OpenClaw
**openclaw/openclaw** · [openclaw.ai](https://openclaw.ai) · [github.com/openclaw/openclaw](https://github.com/openclaw/openclaw)
...
*Referenced in Wikipedia's entry on autonomous AI agents as part of the broader trend toward agents that act independently rather than just responding to prompts.*
...
**Mario Zechner (badlogic)** · [github.com/badlogic/pi-mono](https://github.com/badlogic/pi-mono) · [shittycodingagent.ai](https://shittycodingagent.ai)
...
**agno-agi** · [github.com/agno-agi/agno](https://github.com/agno-agi/agno) · [agno.com](https://agno.com)
...
**mainfra** · [blog.mainfra.me/p/introducing-orchestra](https://blog.mainfra.me/p/introducing-orchestra) · [orchestra.org](https://orchestra.org)
...
| **tapes** | Transparent telemetry collector for agents (191 stars) |
...
A developer builds a working web browser **from scratch** in one week with one human and one LLM agent (Codex), with zero third-party Rust libraries. The browser renders HTML/CSS, handles links, runs on Windows/macOS/Linux via X11 and cURL.
