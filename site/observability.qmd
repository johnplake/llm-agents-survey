...
3. **Runtime guardrail frameworks** — Programmatic rails checked at inference time ([NeMo Guardrails](https://github.com/NVIDIA-NeMo/Guardrails), [Guardrails AI](https://github.com/guardrails-ai/guardrails), custom classifiers). Can be updated without retraining.
...
- (2025). **A Multi-Dimensional Framework for Evaluating Enterprise Agentic AI Systems (CLEAR).** [arXiv:2511.14136](https://arxiv.org/abs/2511.14136)
...
- (2026). **Data-Centric Interpretability for LLM-based Multi-Agent Reinforcement Learning.** [arXiv:2602.05183](https://arxiv.org/abs/2602.05183)
- Ou, T., Guo, W., Gandhi, A., Neubig, G., & Yue, X. (2025). **AgentDiagnose: An Open Toolkit for Diagnosing LLM Agent Trajectories.** EMNLP 2025 Demos. [ACL Anthology](https://aclanthology.org/2025.emnlp-demos.15.pdf)
...
- Shah, M.B., et al. (2026). **Characterizing Faults in Agentic AI: A Taxonomy of Types, Symptoms, and Root Causes.** [arXiv:2603.06847](https://arxiv.org/abs/2603.06847)
- Arcuschin, I., et al. (2025). **Chain-of-Thought Reasoning In The Wild Is Not Always Faithful.** ICLR 2025 Reasoning & Planning for LLMs Workshop. [arXiv:2503.08679](https://arxiv.org/abs/2503.08679)
...
- **[Guardrails AI](https://github.com/guardrails-ai/guardrails)** — Open-source Python framework for adding input/output validation and structured guardrails to LLM applications
