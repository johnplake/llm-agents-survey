...
**Memory access controls** and **memory sandboxing** limit what information can be written to persistent memory (e.g., only the model's own summarization can write to long-term memory, not raw user input), reducing the attack surface for memory-poisoning.
